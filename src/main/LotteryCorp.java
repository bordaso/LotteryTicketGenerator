...
import quicktip.QuickTipFactory;
...
Játékszelvények darabszáma

§  Hány darab játékszelvényt generáljon a rendszer

o   Melyik típusú algoritmust használja a játékszelvények generálásához

§  A fenti 3 lehetõség közül melyiket használja a rendszer

§  Lehetséges értékek: 1, 2, 3
...
public class LotteryCorp {
	...
	QuickTipFactory.getInstance().quickTipAlgoSwitcher(1);
